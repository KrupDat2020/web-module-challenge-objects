...
console.log (createMenuItem('sub', 4, 'lunch'));
...
*/
reviews[7].feedback = 'This place is incredible!!';
console.log(reviews);
...
function getReviewByIndex(array, num) {
  let indexReviews = `${arrays[num].name} gave the restaurant a ${arrays[num].rating} star review, and their review was ${array[num].feedback}`;
  return indexReviews;
}
...
function getLastReview(array) {
  return `{array[array.legth - 1].name} gave the restaurant a ${array[array.length - 1].rating} star review, and their feedback was: ${array[array.length - 1].feedback}`;
} 
